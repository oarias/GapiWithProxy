...
#error Unsupported platform
        ...
        // internal for testing
        internal static async Task<List<RSA>> GetGoogleCertsAsync(IClock clock, bool forceGoogleCertRefresh, string certsJson, bool useProxy, string proxy)
        {
            ...
            try
            {
                ...
                {
                    Proxy proxyObject = new Proxy(proxy);
